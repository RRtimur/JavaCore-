...
public class DBConnection {
    ...
    public DBConnection() {
        try {
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/lesson_8", "root", "root");
    ...
    @SneakyThrows
    public void insertValue(String city, String localDate, String weatherText, int temperature) {
    ...
    public String getValue(String column, String field, int equals){
